;;; da-cal-tex.el --- calendar functions for printing danish calendars with LaTeX

;; Copyright (C) 2010 Søren Lund <soren@lund.org>

;; Author: Søren Lund <soren@lund.org>
;; Version: 1.0
;; Keywords: latex calendar danish localization

;; This file is note part of GNU Emacs.
...
;; This is a localization of some of the standard LaTeX calendar
;; generating functions in cal-tex.el
...
;; 
;;;###cal-autoload
(defun da-cal-tex-cursor-week-iso (&optional n event)
